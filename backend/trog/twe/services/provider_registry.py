...
class ProviderRegistration:
    ...
    settings_reader_factory: Callable[[], object] | None = None
    configuration_reader_factory: Callable[[], object] | None = None
...
class ProviderRegistry:
    ...
    def settings_reader(self, provider_key: str):
        return self._capability(provider_key, "settings_reader_factory")

    def configuration_reader(self, provider_key: str):
        return self._capability(provider_key, "configuration_reader_factory")
...
def build_provider_registry(config, nitrado_transport=None) -> ProviderRegistry:
    ...
    registry.register(
        ...
        ProviderRegistration(
            ...
            settings_reader_factory=lambda: NitradoProvider(config, nitrado_transport),
            configuration_reader_factory=lambda: NitradoProvider(config, nitrado_transport),
